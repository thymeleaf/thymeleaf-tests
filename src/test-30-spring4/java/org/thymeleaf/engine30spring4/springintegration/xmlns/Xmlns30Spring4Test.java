 ...
 * =============================================================================
 */
package org.thymeleaf.engine30spring4.springintegration.xmlns;
...
public class Xmlns30Spring4Test {


    public Xmlns30Spring4Test() {
        super();
    }
    ...
    public void testXmlNs() throws Exception {
        ...
        executor.execute("classpath:engine30spring4/springintegration/xmlns");
