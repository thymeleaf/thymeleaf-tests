 ...
 * =============================================================================
 */
package org.thymeleaf.engine30.stsm;
...
public class STSM30Test {
    ...
    public void testSTSM() throws Exception {
        ...
        contextBuilder.setApplicationContextConfigLocation("classpath:engine30/stsm/applicationContext.xml");
        ...
        executor.execute("classpath:engine30/stsm");
