 ...
 * =============================================================================
 */
package org.thymeleaf.engine30.dataprefix.springsecurity;
...
public class DataPrefixSpringSecurity30Test {


    public DataPrefixSpringSecurity30Test() {
        super();
    }
    ...
    public void testSpringSecurity() throws Exception {
        ...
        processingContextBuilder.setApplicationContextConfigLocation(
                "classpath:engine30/dataprefix/springsecurity/applicationContext-security.xml");
        ...
        executor.execute("classpath:engine30/dataprefix/springsecurity");
