 ...
 * =============================================================================
 */
package org.thymeleaf.engine30.dataprefix.stsm;
...
import org.thymeleaf.engine30.dataprefix.stsm.context.STSMWebProcessingContextBuilder;
import org.thymeleaf.testing.templateengine.engine.TestExecutor;
import org.thymeleaf.tests.util.SpringSpecificVersionUtils;


public class DataPrefixSTSM30Test {
    
    
    public DataPrefixSTSM30Test() {
        super();
    }
    ...
    public void testSTSM() throws Exception {
        ...
        executor.execute("classpath:engine30/dataprefix/stsm");
