 ...
 * =============================================================================
 */
package org.thymeleaf.engine30.springbase;
...
public class SpringBase30Test {


    public SpringBase30Test() {
        super();
    }
    ...
    public void testSpringBase() throws Exception {
        ...
        executor.execute("classpath:engine30/springbase/springbase21.thindex");
