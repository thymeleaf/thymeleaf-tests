...
public class VersionUtilsTest {
    ...
    private void testVersionMatches(final String v, final String bt,
        ...
        Assert.assertEquals(Boolean.valueOf(unknown), Boolean.valueOf(vs.isUnknown()));
        Assert.assertEquals(versionCore, vs.getVersionCore());
        Assert.assertEquals(version, vs.getVersion());
        Assert.assertEquals(fullVersion, vs.getFullVersion());
        Assert.assertEquals(major, vs.getMajor());
        Assert.assertEquals(minor, vs.getMinor());
        Assert.assertEquals(patch, vs.getPatch());
        Assert.assertEquals(qualifier, vs.getQualifier());
        Assert.assertEquals(buildTimestamp, vs.getBuildTimestamp());
    ...
    private void testIsAtLeast(final boolean result, final String v, final int major, final int minor, final int patch)  {
        ...
        Assert.assertTrue(result == vs.isAtLeast(major, minor, patch));
    }
