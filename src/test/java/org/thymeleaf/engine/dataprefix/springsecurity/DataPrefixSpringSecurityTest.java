 ...
 * =============================================================================
 */
package org.thymeleaf.engine.dataprefix.springsecurity;
...
public class DataPrefixSpringSecurityTest {
    ...
    public void testSpringSecurity() throws Exception {
        ...
        processingContextBuilder.setApplicationContextConfigLocation(
                "classpath:engine/dataprefix/springsecurity/applicationContext-security.xml");
        ...
        executor.execute("classpath:engine/dataprefix/springsecurity");
